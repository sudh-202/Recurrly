      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }} className="auth-scroll">
        <View className="auth-content justify-center pb-20">
          ...
          <View className="auth-brand-block mb-10">
            ...
            <Text className="auth-title mb-2 text-center text-3xl font-sans-bold text-primary">Create Account</Text>
          ...
          <View className="auth-card mx-5 rounded-3xl border border-black/10 bg-[#fdf5e6] p-6 shadow-sm">
            <View className="auth-form gap-y-5">
              <View className="auth-field">
                <Text className="auth-label text-base font-sans-bold text-primary mb-2">Name</Text>
                <TextInput
              ...
              >
                <Text className="auth-button-text text-white text-lg font-sans-bold">Sign up</Text>
              </TouchableOpacity>
            </View>
